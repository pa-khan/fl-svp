  ...
  <div class="episode"
    ...
    <div class="episode__wrap">
      <div class="episode__inner">
        ...
        <div class="episode__share share" v-if="item.type == 4 || item.type == 5">
            ...
            <a href="" class="share__item" target="_blank">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  fill="#344463" />
                <path d="M6.46383 14.95L5.04883 13.536L13.5358 5.05005L14.9498 6.46505L6.46383 14.95Z" fill="#344463" />
              </svg>
            </a>
            <a href="" class="share__item" target="_blank">
        ...
        <div class="episode__review" v-if="item.type == 4 || item.type == 5">
          <div class="episode__review-title">Пожалуйста оцените эту серию</div>
          <div class="episode__review-list">
            <div class="episode__review-item"></div>
          </div>
        </div>
      </div>
